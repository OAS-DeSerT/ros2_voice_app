...
int main(int argc, char* argv[])
{
	...
	*/
	...
	auto node = rclcpp::Node::make_shared("VoiceAssistant");
	auto sub = node->create_subscription<std_msgs::msg::String>("voiceWords", 10, voiceWordsCallback);
	rclcpp::spin(node);
